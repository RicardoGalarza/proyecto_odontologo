...
class PacienteServiceTest {
    ...
    public void testGuardarPaciente() {
        ...
        Paciente paciente= new Paciente("Ricardo", "Galarza", "123k", LocalDate.of(2023,11,28),new Domicilio("calle",123,"localidad","provincia"), "hola@gmail.com");
    ...
    public void testActualizarPaciente(){
        ...
        Paciente pacienteInicial= new Paciente("Ricardo", "Galarza", "23423", LocalDate.of(2023,11,28),new Domicilio("calle",123,"localidad","provincia"), "hola1@gmail.com");
        pacienteService.guardarPaciente(pacienteInicial);

        //Actualizamos paciente inciail
        Paciente pacienteActualizado = new Paciente(1L, "caty", "Lucena", "12345E", LocalDate.of(2023,11,28),new Domicilio("calle",123,"localidad","provincia"), "chao@gmail.com");
    ...
    public void testEliminarPaciente(){
        ...
        Paciente pacienteInicial= new Paciente("Ricardo", "Galarza", "34545", LocalDate.of(2023,11,28),new Domicilio("calle",123,"localidad","provincia"), "hola2@gmail.com");
        pacienteService.guardarPaciente(pacienteInicial);
