...
class TurnoServiceTest {
    ...
    public void testGuardarTurno(){
        ...
        Odontologo odontologo=new Odontologo(444,"Ricardo", "Galarza");
    ...
    public void testEliminarTurno(){
        ...
        //Guardamos Paciente
        Paciente paciente= new Paciente("Ricardo", "Jose", "12345k", LocalDate.of(2023,11,28),new Domicilio("calle",123,"localidad","provincia"), "hola2@gmail.com");
        Paciente pacienteGuardado = pacienteService.guardarPaciente(paciente);

        //Guardamos Odontologo
        Odontologo odontologo=new Odontologo(3244,"Ricardo", "Galarza");
        Odontologo odontologoGuardado = odontologoService.guardarOdontologo(odontologo);
