...
class OdontologoServiceTest {
    ...
    public void testActualizarOdontolgoo(){
        ...
        Odontologo odontologoInicial = new Odontologo(333, "Ricardo", "Galarza");
        odontologoService.guardarOdontologo(odontologoInicial);

        //Actualizamos la matricula del odontologo
        Odontologo odontologoActualizado = new Odontologo(odontologoInicial.getId(),555, "Ricardo", "Galarza");
